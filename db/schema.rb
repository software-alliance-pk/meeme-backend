...
ActiveRecord::Schema[7.0].define(version: 2023_06_20_094446) do
  ...
  create_table "themes", force: :cascade do |t|
    t.string "title"
    t.string "font"
    t.string "nav_background_color", default: [], array: true
    t.string "background_colors", default: [], array: true
    t.string "background_colors_percentage", default: [], array: true
    t.string "buttons_color", default: [], array: true
    t.string "buttons_color_percentage", default: [], array: true
    t.string "theme_type"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "buy_price"
  ...
  create_table "tournament_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "total_judged_coins", default: 0
  end
