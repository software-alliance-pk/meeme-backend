...
tutorials = { 1 => ["Memee will have a monthly Tournament that users can join."],
              ...
              4 => ["There are also other ways to accumulate coins. Judging is another way of acquiring coins from the app. End Users can  judge 25 memes daily and gain 50 coins on a daily basis."],
