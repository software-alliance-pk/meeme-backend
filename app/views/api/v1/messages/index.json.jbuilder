...
json.messages @messages.each do |record|
    ...
    json.sender_image record&.sender&.profile_image&.attached? ? CloudfrontUrlService.new(record.sender.profile_image).cloudfront_url : ''
    json.receiver_image record&.receiver&.profile_image&.attached? ? CloudfrontUrlService.new(record.receiver.profile_image).cloudfront_url : ''
end
