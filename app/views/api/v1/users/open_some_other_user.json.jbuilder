json.profile do
  ...
  json.user_posts_count @user.posts.where(tournament_meme: false).count
  ...
  json.tournament_posts_count @user.posts.where(tournament_meme: true).count
  json.tournament_posts @user.posts.where(tournament_meme: true).each do |post|
    json.post_description post.description
    json.post_image post.post_image.attached? ? post.post_image.blob.url : ''
    json.post_time post.created_at
    json.post_image post.post_image.attached? ? post.post_image.blob.url : ''
