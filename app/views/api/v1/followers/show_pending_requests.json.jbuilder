...
json.pending_followers @user_followers.each do|follower|
  ...
  json.user_image User.find(follower.user_id).profile_image.attached? ? CloudfrontUrlService.new(User.find(follower.user_id).profile_image).cloudfront_url : ''
  ...
  json.follower_image User.find(follower.follower_user_id).profile_image.attached? ? CloudfrontUrlService.new(User.find(follower.follower_user_id).profile_image).cloudfront_url : ''
