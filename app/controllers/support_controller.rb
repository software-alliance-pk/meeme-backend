class SupportController < ApplicationController
    def show_chat
        ...
        if params[:email].present?
            ...
            @admin_image = @admin.admin_profile_image.attached? ? @admin.admin_profile_image.blob.url : ActionController::Base.helpers.asset_path('user.png')
        end
    ...
    def get_profile_image
        if params[:email].present?
            @user = User.find_by(email: params[:email])
            @image = @user.profile_image.attached? ? @user.profile_image.blob.url : ActionController::Base.helpers.asset_path('user.png')
            respond_to do |format|
    ...
    def render_message(message)
        {
          ...
          sender_image: message.admin_user.admin_profile_image.attached? ? message.admin_user.admin_profile_image.blob.url : '',
